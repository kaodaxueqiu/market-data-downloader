...
import { Loading, Search, DataLine, Document, Operation } from '@element-plus/icons-vue'
...
const emit = defineEmits<{
  select: [result: SearchResult, dataType: 'market' | 'static' | 'processed']
  close: []
}>()

const handleSelect = (result: SearchResult, dataType: 'market' | 'static' | 'processed') => {
