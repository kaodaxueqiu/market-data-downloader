...
func (r *Relation) deleteFriendRequestsFromUser(ctx context.Context, req *relation.DeleteFriendRequestsFromUserReq) error {
	return api.DeleteFriendRequestsFromUser.Execute(ctx, req)
}

func (r *Relation) deleteFriendRequestsToUser(ctx context.Context, req *relation.DeleteFriendRequestsToUserReq) error {
	return api.DeleteFriendRequestsToUser.Execute(ctx, req)
}
