...
func (g *Group) muteGroup(ctx context.Context, groupID string, muteBypassUserIDs []string) error {
	return api.MuteGroup.Execute(ctx, &group.MuteGroupReq{GroupID: groupID, MuteBypassUserIDs: muteBypassUserIDs})
}
...
func (g *Group) deleteGroupRequestsFromUser(ctx context.Context, req *group.DeleteGroupRequestsFromUserReq) error {
	return api.DeleteGroupRequestsFromUser.Execute(ctx, req)
}

func (g *Group) deleteGroupRequestsToGroup(ctx context.Context, req *group.DeleteGroupRequestsToGroupReq) error {
	return api.DeleteGroupRequestsToGroup.Execute(ctx, req)
}
