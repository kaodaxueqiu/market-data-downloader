...
//		if e.Value.(*msg.ActiveConversation).ConversationIDs == conversationID {
...
//	_, ap := pinned[a.ConversationIDs]
//	_, bp := pinned[b.ConversationIDs]
//	if ap != bp {
//		if ap {
//			return 1
//		}
