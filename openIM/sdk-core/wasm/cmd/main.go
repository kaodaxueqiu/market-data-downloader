...
func registerFunc() {
	...
	js.Global().Set("createMarkdownMessage", js.FuncOf(wrapperConMsg.CreateMarkdownMessage))
	...
	js.Global().Set("createForwardMessage", js.FuncOf(wrapperConMsg.CreateForwardMessage))
	js.Global().Set("createTargetedGroupMessage", js.FuncOf(wrapperConMsg.CreateTargetedGroupMessage))
	js.Global().Set("createLocationMessage", js.FuncOf(wrapperConMsg.CreateLocationMessage))
	...
	js.Global().Set("sendGroupMessageReadReceipt", js.FuncOf(wrapperConMsg.SendGroupMessageReadReceipt))
	js.Global().Set("getGroupMessageReaderList", js.FuncOf(wrapperConMsg.GetGroupMessageReaderList))
	...
	js.Global().Set("getAllHistoryMessages", js.FuncOf(wrapperConMsg.GetAllHistoryMessages))
	...
	js.Global().Set("deleteMessages", js.FuncOf(wrapperConMsg.DeleteMessages))
	js.Global().Set("deleteUserAllMessagesInConv", js.FuncOf(wrapperConMsg.DeleteUserAllMessagesInConv))
	...
	js.Global().Set("setMessageLocalContent", js.FuncOf(wrapperConMsg.SetMessageLocalContent))
	...
	js.Global().Set("modifyMessage", js.FuncOf(wrapperConMsg.ModifyMessage))
	js.Global().Set("setConversationPinnedMsg", js.FuncOf(wrapperConMsg.SetConversationPinnedMsg))
	js.Global().Set("getConversationPinnedMsg", js.FuncOf(wrapperConMsg.GetConversationPinnedMsg))
	js.Global().Set("resetConversationUnread", js.FuncOf(wrapperConMsg.ResetConversationUnread))
	js.Global().Set("createConversationGroup", js.FuncOf(wrapperConMsg.CreateConversationGroup))
	js.Global().Set("updateConversationGroup", js.FuncOf(wrapperConMsg.UpdateConversationGroup))
	js.Global().Set("deleteConversationGroup", js.FuncOf(wrapperConMsg.DeleteConversationGroup))
	js.Global().Set("getConversationGroups", js.FuncOf(wrapperConMsg.GetConversationGroups))
	js.Global().Set("setConversationGroupOrder", js.FuncOf(wrapperConMsg.SetConversationGroupOrder))
	js.Global().Set("addConversationsToGroups", js.FuncOf(wrapperConMsg.AddConversationsToGroups))
	js.Global().Set("removeConversationsFromGroups", js.FuncOf(wrapperConMsg.RemoveConversationsFromGroups))
	js.Global().Set("getConversationGroupIDsByConversationID", js.FuncOf(wrapperConMsg.GetConversationGroupIDsByConversationID))
	js.Global().Set("getConversationGroupInfoWithConversations", js.FuncOf(wrapperConMsg.GetConversationGroupInfoWithConversations))
	...
	js.Global().Set("deleteGroupRequests", js.FuncOf(wrapperGroup.DeleteGroupRequests))
	...
	js.Global().Set("getFileTransfer", js.FuncOf(wrapperUser.GetFileTransfer))
	...
	js.Global().Set("deleteFriendRequests", js.FuncOf(wrapperFriend.DeleteFriendRequests))
	...
	js.Global().Set("getSignalingInvitationInfoStartApp", js.FuncOf(wrapperSignaling.GetSignalingInvitationInfoStartApp))
	...
	js.Global().Set("createTimerTask", js.FuncOf(wrapperThird.CreateTimerTask))
	js.Global().Set("updateTimerTask", js.FuncOf(wrapperThird.UpdateTimerTask))
	js.Global().Set("deleteTimerTask", js.FuncOf(wrapperThird.DeleteTimerTask))
	js.Global().Set("getTimerTask", js.FuncOf(wrapperThird.GetTimerTask))
	js.Global().Set("listTimerTasks", js.FuncOf(wrapperThird.ListTimerTasks))
	js.Global().Set("createMessageTimerTask", js.FuncOf(wrapperThird.CreateMessageTimerTask))
	js.Global().Set("createHttpTimerTask", js.FuncOf(wrapperThird.CreateHttpTimerTask))
	js.Global().Set("createRpcTimerTask", js.FuncOf(wrapperThird.CreateRpcTimerTask))
	js.Global().Set("createPresetTimerTask", js.FuncOf(wrapperThird.CreatePresetTimerTask))
	js.Global().Set("updateMessageTimerTask", js.FuncOf(wrapperThird.UpdateMessageTimerTask))
	js.Global().Set("updateHttpTimerTask", js.FuncOf(wrapperThird.UpdateHttpTimerTask))
	js.Global().Set("updateRpcTimerTask", js.FuncOf(wrapperThird.UpdateRpcTimerTask))
	js.Global().Set("updatePresetTimerTask", js.FuncOf(wrapperThird.UpdatePresetTimerTask))
	js.Global().Set("speechToText", js.FuncOf(wrapperThird.SpeechToText))
	js.Global().Set("speechToTextCapabilities", js.FuncOf(wrapperThird.SpeechToTextCapabilities))
	js.Global().Set("setTemporaryLevel", js.FuncOf(wrapperThird.SetTemporaryLevel))
