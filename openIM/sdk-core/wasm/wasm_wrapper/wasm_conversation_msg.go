...
func (w *WrapperConMsg) CreateMarkdownMessage(_ js.Value, args []js.Value) interface{} {
	return event_listener.NewCaller(open_im_sdk.CreateMarkdownMessage, nil, &args).AsyncCallWithOutCallback()
}
...
func (w *WrapperConMsg) CreateTargetedGroupMessage(_ js.Value, args []js.Value) interface{} {
	return event_listener.NewCaller(open_im_sdk.CreateTargetedGroupMessage, nil, &args).AsyncCallWithOutCallback()
}
...
func (w *WrapperConMsg) SendGroupMessageReadReceipt(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.SendGroupMessageReadReceipt, callback, &args).AsyncCallWithCallback()
}

func (w *WrapperConMsg) GetGroupMessageReaderList(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.GetGroupMessageReaderList, callback, &args).AsyncCallWithCallback()
}
...
func (w *WrapperConMsg) DeleteMessages(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.DeleteMessages, callback, &args).AsyncCallWithCallback()
}

func (w *WrapperConMsg) DeleteUserAllMessagesInConv(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.DeleteUserAllMessagesInConv, callback, &args).AsyncCallWithCallback()
}
...
func (w *WrapperConMsg) SetMessageLocalContent(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.SetMessageLocalContent, callback, &args).AsyncCallWithCallback()
}
...
func (w *WrapperConMsg) ModifyMessage(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.ModifyMessage, callback, &args).AsyncCallWithCallback()
}

func (w *WrapperConMsg) SetConversationPinnedMsg(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.SetConversationPinnedMsg, callback, &args).AsyncCallWithCallback()
}

func (w *WrapperConMsg) GetConversationPinnedMsg(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.GetConversationPinnedMsg, callback, &args).AsyncCallWithCallback()
}

func (w *WrapperConMsg) ResetConversationUnread(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.ResetConversationUnread, callback, &args).AsyncCallWithCallback()
}

func (w *WrapperConMsg) CreateConversationGroup(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.CreateConversationGroup, callback, &args).AsyncCallWithCallback()
}

func (w *WrapperConMsg) UpdateConversationGroup(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.UpdateConversationGroup, callback, &args).AsyncCallWithCallback()
}

func (w *WrapperConMsg) DeleteConversationGroup(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.DeleteConversationGroup, callback, &args).AsyncCallWithCallback()
}

func (w *WrapperConMsg) GetConversationGroups(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.GetConversationGroups, callback, &args).AsyncCallWithCallback()
}

func (w *WrapperConMsg) SetConversationGroupOrder(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.SetConversationGroupOrder, callback, &args).AsyncCallWithCallback()
}

func (w *WrapperConMsg) AddConversationsToGroups(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.AddConversationsToGroups, callback, &args).AsyncCallWithCallback()
}

func (w *WrapperConMsg) RemoveConversationsFromGroups(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.RemoveConversationsFromGroups, callback, &args).AsyncCallWithCallback()
}

func (w *WrapperConMsg) GetConversationGroupIDsByConversationID(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.GetConversationGroupByConversationID, callback, &args).AsyncCallWithCallback()
}

func (w *WrapperConMsg) GetConversationGroupInfoWithConversations(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.GetConversationGroupInfoWithConversations, callback, &args).AsyncCallWithCallback()
}
