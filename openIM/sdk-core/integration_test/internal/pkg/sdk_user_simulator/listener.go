...
func (c *conversationCallBack) OnConversationGroupChanged(conversationList string) {
}
...
func (m *MsgListenerCallBak) OnChangedPinnedMsg(message string) {}
...
func (m *MsgListenerCallBak) OnDeleteUserAllMsgsInConv(message string) {}
...
func (t *testConnListener) OnKickedOffline(msg string) {
	log.ZError(context.TODO(), "kicked offline", errs.New("kicked offline").Wrap(), "userID", t.UserID, "msg", msg)
}
...
func (TestSendMsgCallBack) OnSuccess(data string) {
}

func (TestSendMsgCallBack) OnError(code int32, msg string) {
}

func (TestSendMsgCallBack) OnProgress(progress int) {
}
