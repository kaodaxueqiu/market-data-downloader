...
func (x *GetConversationPinnedMsgReq) Check() error {
	if x.ConversationID == "" {
		return errors.New("conversationID is empty")
	}
	return nil
...
func (x *SetConversationPinnedMsgReq) Check() error {
	if x.ConversationID == "" {
		return errors.New("conversationID is empty")
	}
	if x.UserID == "" {
...
func (x *CreateConversationGroupReq) Check() error {
	if x.OwnerUserID == "" {
		return errors.New("ownerUserID is empty")
	}
	if x.Name == "" {
...
func (x *UpdateConversationGroupReq) Check() error {
	if x.ConversationGroupID == "" {
		return errors.New("groupID is empty")
	}
	if x.OwnerUserID == "" {
		return errors.New("ownerUserID is empty")
...
func (x *DeleteConversationGroupReq) Check() error {
	if x.ConversationGroupID == "" {
		return errors.New("groupID is empty")
	}
	if x.OwnerUserID == "" {
...
func (x *GetConversationGroupsReq) Check() error {
	if x.OwnerUserID == "" {
		return errors.New("ownerUserID is empty")
	}
	if x.MaxVersion != nil && x.MaxVersion.Value < 0 {
		return errors.New("maxVersion is invalid")
	}
	return nil
}

func (x *SetConversationGroupOrderReq) Check() error {
	if x.OwnerUserID == "" {
		return errors.New("ownerUserID is empty")
	}
	if x.Orders == nil {
...
func (x *AddConversationsToGroupsReq) Check() error {
	if x.OwnerUserID == "" {
		return errors.New("ownerUserID is empty")
	}
	...
	for _, conversationID := range x.ConversationIDs {
		if conversationID == "" {
			return errors.New("conversationID is empty")
		}
	}
	if len(x.ConversationGroupIDs) == 0 {
		return errors.New("conversationGroupIDs is empty")
	}
	for _, conversationGroupID := range x.ConversationGroupIDs {
		if conversationGroupID == "" {
			return errors.New("conversationGroupID is empty")
		}
	}
	return nil
}

func (x *RemoveConversationsFromGroupsReq) Check() error {
	if x.OwnerUserID == "" {
		return errors.New("ownerUserID is empty")
	}
	if len(x.ConversationIDs) == 0 {
