...
type OnlineBatchPushMsgReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MsgData       []*sdkws.MsgData       `protobuf:"bytes,1,rep,name=msgData,proto3" json:"msgData"`
	PushToUserIDs []string               `protobuf:"bytes,2,rep,name=pushToUserIDs,proto3" json:"pushToUserIDs"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *OnlineBatchPushMsgReq) Reset() {
	*x = OnlineBatchPushMsgReq{}
	mi := &file_msggateway_msggateway_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *OnlineBatchPushMsgReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OnlineBatchPushMsgReq) ProtoMessage() {}

func (x *OnlineBatchPushMsgReq) ProtoReflect() protoreflect.Message {
	mi := &file_msggateway_msggateway_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OnlineBatchPushMsgReq.ProtoReflect.Descriptor instead.
func (*OnlineBatchPushMsgReq) Descriptor() ([]byte, []int) {
	return file_msggateway_msggateway_proto_rawDescGZIP(), []int{5}
}

func (x *OnlineBatchPushMsgReq) GetMsgData() []*sdkws.MsgData {
	if x != nil {
		return x.MsgData
	}
	return nil
...
func (x *OnlineBatchPushMsgReq) GetPushToUserIDs() []string {
	if x != nil {
		return x.PushToUserIDs
	}
	return nil
...
type OnlineBatchPushMsgResp struct {
	state            protoimpl.MessageState    `protogen:"open.v1"`
	SinglePushResult []*SingleMsgToUserResults `protobuf:"bytes,1,rep,name=singlePushResult,proto3" json:"singlePushResult"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
...
func (x *OnlineBatchPushMsgResp) Reset() {
	*x = OnlineBatchPushMsgResp{}
	mi := &file_msggateway_msggateway_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *OnlineBatchPushMsgResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OnlineBatchPushMsgResp) ProtoMessage() {}

func (x *OnlineBatchPushMsgResp) ProtoReflect() protoreflect.Message {
	mi := &file_msggateway_msggateway_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OnlineBatchPushMsgResp.ProtoReflect.Descriptor instead.
func (*OnlineBatchPushMsgResp) Descriptor() ([]byte, []int) {
	return file_msggateway_msggateway_proto_rawDescGZIP(), []int{6}
}

func (x *OnlineBatchPushMsgResp) GetSinglePushResult() []*SingleMsgToUserResults {
	if x != nil {
		return x.SinglePushResult
	}
	return nil
...
type KickUserOfflineReq struct {
	...
	KickType       string                 `protobuf:"bytes,3,opt,name=kickType,proto3" json:"kickType"`
...
func (x *KickUserOfflineReq) GetKickType() string {
	if x != nil {
		return x.KickType
	}
	return ""
...
func (x *KickUserOfflineReq) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (*MultiTerminalLoginCheckResp) Descriptor() ([]byte, []int) {
	return file_msggateway_msggateway_proto_rawDescGZIP(), []int{15}
}
...
func (*GetUsersOnlineStatusResp_SuccessDetail) Descriptor() ([]byte, []int) {
	return file_msggateway_msggateway_proto_rawDescGZIP(), []int{9, 0}
}
...
func (*GetUsersOnlineStatusResp_FailedDetail) Descriptor() ([]byte, []int) {
	return file_msggateway_msggateway_proto_rawDescGZIP(), []int{9, 1}
}
...
func (x *GetUsersOnlineStatusResp_SuccessResult) Reset() {
	*x = GetUsersOnlineStatusResp_SuccessResult{}
	mi := &file_msggateway_msggateway_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetUsersOnlineStatusResp_SuccessResult) Descriptor() ([]byte, []int) {
	return file_msggateway_msggateway_proto_rawDescGZIP(), []int{9, 2}
}
...
const file_msggateway_msggateway_proto_rawDesc = "" +
	...
	"\x10singlePushResult\x18\x01 \x03(\v2).openim.msggateway.SingleMsgToUserResultsR\x10singlePushResult\"n\n" +
	"\x15OnlineBatchPushMsgReq\x12/\n" +
	"\amsgData\x18\x01 \x03(\v2\x15.openim.sdkws.MsgDataR\amsgData\x12$\n" +
	"\rpushToUserIDs\x18\x02 \x03(\tR\rpushToUserIDs\"o\n" +
	"\x16OnlineBatchPushMsgResp\x12U\n" +
	...
	"\x05token\x18\x03 \x03(\tR\x05token\"\x90\x01\n" +
	"\x12KickUserOfflineReq\x12\x1e\n" +
	"\n" +
	"platformID\x18\x01 \x01(\x05R\n" +
	"platformID\x12&\n" +
	"\x0ekickUserIDList\x18\x02 \x03(\tR\x0ekickUserIDList\x12\x1a\n" +
	"\bkickType\x18\x03 \x01(\tR\bkickType\x12\x16\n" +
	"\x06reason\x18\x04 \x01(\tR\x06reason\"\x15\n" +
	...
	"\x1bMultiTerminalLoginCheckResp2\x92\x06\n" +
	"\n" +
	"msgGateway\x12Z\n" +
	...
	"\x1fSuperGroupOnlineBatchPushOneMsg\x12+.openim.msggateway.OnlineBatchPushOneMsgReq\x1a,.openim.msggateway.OnlineBatchPushOneMsgResp\x12i\n" +
	"\x12OnlineBatchPushMsg\x12(.openim.msggateway.OnlineBatchPushMsgReq\x1a).openim.msggateway.OnlineBatchPushMsgResp\x12`\n" +
...
var file_msggateway_msggateway_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_msggateway_msggateway_proto_goTypes = []any{
	...
	(*OnlineBatchPushMsgReq)(nil),                  // 5: openim.msggateway.OnlineBatchPushMsgReq
	(*OnlineBatchPushMsgResp)(nil),                 // 6: openim.msggateway.OnlineBatchPushMsgResp
	(*SingleMsgToUserPlatform)(nil),                // 7: openim.msggateway.SingleMsgToUserPlatform
	(*GetUsersOnlineStatusReq)(nil),                // 8: openim.msggateway.GetUsersOnlineStatusReq
	(*GetUsersOnlineStatusResp)(nil),               // 9: openim.msggateway.GetUsersOnlineStatusResp
	(*SingleDetail)(nil),                           // 10: openim.msggateway.SingleDetail
	(*SinglePlatformToken)(nil),                    // 11: openim.msggateway.SinglePlatformToken
	(*KickUserOfflineReq)(nil),                     // 12: openim.msggateway.KickUserOfflineReq
	(*KickUserOfflineResp)(nil),                    // 13: openim.msggateway.KickUserOfflineResp
	(*MultiTerminalLoginCheckReq)(nil),             // 14: openim.msggateway.MultiTerminalLoginCheckReq
	(*MultiTerminalLoginCheckResp)(nil),            // 15: openim.msggateway.MultiTerminalLoginCheckResp
	(*GetUsersOnlineStatusResp_SuccessDetail)(nil), // 16: openim.msggateway.GetUsersOnlineStatusResp.SuccessDetail
	(*GetUsersOnlineStatusResp_FailedDetail)(nil),  // 17: openim.msggateway.GetUsersOnlineStatusResp.FailedDetail
	(*GetUsersOnlineStatusResp_SuccessResult)(nil), // 18: openim.msggateway.GetUsersOnlineStatusResp.SuccessResult
	(*sdkws.MsgData)(nil),                          // 19: openim.sdkws.MsgData
}
var file_msggateway_msggateway_proto_depIdxs = []int32{
	19, // 0: openim.msggateway.OnlinePushMsgReq.msgData:type_name -> openim.sdkws.MsgData
	7,  // 1: openim.msggateway.OnlinePushMsgResp.resp:type_name -> openim.msggateway.SingleMsgToUserPlatform
	7,  // 2: openim.msggateway.SingleMsgToUserResults.resp:type_name -> openim.msggateway.SingleMsgToUserPlatform
	19, // 3: openim.msggateway.OnlineBatchPushOneMsgReq.msgData:type_name -> openim.sdkws.MsgData
	2,  // 4: openim.msggateway.OnlineBatchPushOneMsgResp.singlePushResult:type_name -> openim.msggateway.SingleMsgToUserResults
	19, // 5: openim.msggateway.OnlineBatchPushMsgReq.msgData:type_name -> openim.sdkws.MsgData
	2,  // 6: openim.msggateway.OnlineBatchPushMsgResp.singlePushResult:type_name -> openim.msggateway.SingleMsgToUserResults
	18, // 7: openim.msggateway.GetUsersOnlineStatusResp.successResult:type_name -> openim.msggateway.GetUsersOnlineStatusResp.SuccessResult
	17, // 8: openim.msggateway.GetUsersOnlineStatusResp.failedResult:type_name -> openim.msggateway.GetUsersOnlineStatusResp.FailedDetail
	11, // 9: openim.msggateway.SingleDetail.singlePlatformToken:type_name -> openim.msggateway.SinglePlatformToken
	16, // 10: openim.msggateway.GetUsersOnlineStatusResp.SuccessResult.detailPlatformStatus:type_name -> openim.msggateway.GetUsersOnlineStatusResp.SuccessDetail
	0,  // 11: openim.msggateway.msgGateway.OnlinePushMsg:input_type -> openim.msggateway.OnlinePushMsgReq
	8,  // 12: openim.msggateway.msgGateway.GetUsersOnlineStatus:input_type -> openim.msggateway.GetUsersOnlineStatusReq
	3,  // 13: openim.msggateway.msgGateway.OnlineBatchPushOneMsg:input_type -> openim.msggateway.OnlineBatchPushOneMsgReq
	3,  // 14: openim.msggateway.msgGateway.SuperGroupOnlineBatchPushOneMsg:input_type -> openim.msggateway.OnlineBatchPushOneMsgReq
	5,  // 15: openim.msggateway.msgGateway.OnlineBatchPushMsg:input_type -> openim.msggateway.OnlineBatchPushMsgReq
	12, // 16: openim.msggateway.msgGateway.KickUserOffline:input_type -> openim.msggateway.KickUserOfflineReq
	14, // 17: openim.msggateway.msgGateway.MultiTerminalLoginCheck:input_type -> openim.msggateway.MultiTerminalLoginCheckReq
	1,  // 18: openim.msggateway.msgGateway.OnlinePushMsg:output_type -> openim.msggateway.OnlinePushMsgResp
	9,  // 19: openim.msggateway.msgGateway.GetUsersOnlineStatus:output_type -> openim.msggateway.GetUsersOnlineStatusResp
	4,  // 20: openim.msggateway.msgGateway.OnlineBatchPushOneMsg:output_type -> openim.msggateway.OnlineBatchPushOneMsgResp
	4,  // 21: openim.msggateway.msgGateway.SuperGroupOnlineBatchPushOneMsg:output_type -> openim.msggateway.OnlineBatchPushOneMsgResp
	6,  // 22: openim.msggateway.msgGateway.OnlineBatchPushMsg:output_type -> openim.msggateway.OnlineBatchPushMsgResp
	13, // 23: openim.msggateway.msgGateway.KickUserOffline:output_type -> openim.msggateway.KickUserOfflineResp
	15, // 24: openim.msggateway.msgGateway.MultiTerminalLoginCheck:output_type -> openim.msggateway.MultiTerminalLoginCheckResp
