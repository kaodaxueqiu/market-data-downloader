...
const (
	...
	MsgGateway_OnlineBatchPushMsg_FullMethodName              = "/openim.msggateway.msgGateway/OnlineBatchPushMsg"
...
type MsgGatewayClient interface {
	...
	OnlineBatchPushMsg(ctx context.Context, in *OnlineBatchPushMsgReq, opts ...grpc.CallOption) (*OnlineBatchPushMsgResp, error)
...
func (c *msgGatewayClient) OnlineBatchPushMsg(ctx context.Context, in *OnlineBatchPushMsgReq, opts ...grpc.CallOption) (*OnlineBatchPushMsgResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OnlineBatchPushMsgResp)
	err := c.cc.Invoke(ctx, MsgGateway_OnlineBatchPushMsg_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgGatewayServer interface {
	...
	OnlineBatchPushMsg(context.Context, *OnlineBatchPushMsgReq) (*OnlineBatchPushMsgResp, error)
...
func (UnimplementedMsgGatewayServer) OnlineBatchPushMsg(context.Context, *OnlineBatchPushMsgReq) (*OnlineBatchPushMsgResp, error) {
	return nil, status.Error(codes.Unimplemented, "method OnlineBatchPushMsg not implemented")
}
...
func _MsgGateway_OnlineBatchPushMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OnlineBatchPushMsgReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgGatewayServer).OnlineBatchPushMsg(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MsgGateway_OnlineBatchPushMsg_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgGatewayServer).OnlineBatchPushMsg(ctx, req.(*OnlineBatchPushMsgReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MsgGateway_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "OnlineBatchPushMsg",
			Handler:    _MsgGateway_OnlineBatchPushMsg_Handler,
		},
		{
