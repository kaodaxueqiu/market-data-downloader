...
const (
	...
	Auth_DeleteUsersTokens_FullMethodName = "/openim.auth.Auth/deleteUsersTokens"
)
...
type AuthClient interface {
	...
	// delete users tokens
	DeleteUsersTokens(ctx context.Context, in *DeleteUsersTokensReq, opts ...grpc.CallOption) (*DeleteUsersTokensResp, error)
}
...
func (c *authClient) DeleteUsersTokens(ctx context.Context, in *DeleteUsersTokensReq, opts ...grpc.CallOption) (*DeleteUsersTokensResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteUsersTokensResp)
	err := c.cc.Invoke(ctx, Auth_DeleteUsersTokens_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	...
	// delete users tokens
	DeleteUsersTokens(context.Context, *DeleteUsersTokensReq) (*DeleteUsersTokensResp, error)
...
func (UnimplementedAuthServer) DeleteUsersTokens(context.Context, *DeleteUsersTokensReq) (*DeleteUsersTokensResp, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteUsersTokens not implemented")
}
...
func _Auth_DeleteUsersTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteUsersTokensReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).DeleteUsersTokens(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_DeleteUsersTokens_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).DeleteUsersTokens(ctx, req.(*DeleteUsersTokensReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "deleteUsersTokens",
			Handler:    _Auth_DeleteUsersTokens_Handler,
		},
	},
