...
const (
	...
	ConversationGroupChangeNotification = 1704
...
const (
	...
	Token           = "token"
	RpcCustomHeader = "customHeader" // custom ctx parameter in rpc middleware
	CheckKey        = "CheckKey"
	TriggerID       = "triggerID"
...
const (
	BecomeFriendByImport = 1 // imported by admin
	BecomeFriendByApply  = 2 // applied to add
)

const (
	ApplyNeedVerificationInviteDirectly = 0 // application requires approval, invitation directly enters
	AllNeedVerification                 = 1 // everyone joining group requires verification, except invited by group owner/admin
	Directly                            = 2 // join directly
)
...
const (
	GroupMessageReadMarked  = 0 // Already marked
	GroupMessageReadMarkNew = 1 // Newly marked
)
...
const (
	AddFriendAllowed         = iota // 0: Allow to be added as a friend (requires approval)
