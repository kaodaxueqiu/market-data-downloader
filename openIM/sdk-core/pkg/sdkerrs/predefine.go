...
var (
	...
	ErrMsgSendFailed            = errs.NewCodeError(MsgSendFailedError, "Message sending failed")
	ErrMsgHasDeleted            = errs.NewCodeError(MsgHasDeletedError, "Message has been deleted")
	ErrMsgEmpty                 = errs.NewCodeError(MsgEmptyError, "empty msg")                     // msg
	ErrMsgSenders               = errs.NewCodeError(MsgSendersError, "msg senders is not yourself") // msg

	ErrMsgEncryptionKeyNotFound = errs.NewCodeError(MsgEncryptionKeyNotFound, "MsgEncryptionKeyNotFound")
...
var (
	// server errors
	ErrGroupReadOff = errs.NewCodeError(GroupReadOffError, "GroupReadOff")
)
