...
const (
	...
	MsgEmptyError                 = 10207 // Message is empty
	MsgSendersError               = 10208 // Message sender error
	MsgSendFailedError            = 10209 // Message sending failed

	MsgEncryptionKeyNotFound = 10210 // Message Encryption key not found
	...
	// Third errors
	CancelUploadingFile = 10500 // cancel uploading a file
)

const (
	// server errors.
	// Only used to determine server-side errors in special scenarios.
	GroupReadOffError = 1250
)
