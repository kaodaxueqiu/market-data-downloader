...
type LocalGroup struct {
	...
	DisplayIsRead          bool        `gorm:"column:display_is_read" json:"displayIsRead"`
	MuteBypassUserIDs      StringArray `gorm:"column:mute_bypass_user_ids" json:"muteBypassUserIDs"`
}
...
type LocalEvent struct {
	...
	Type            string `gorm:"column:type;index;type:varchar(64)" json:"type"`   // Event type, e.g., "conv.patchMemberInfo"
	Payload         string `gorm:"column:payload;type:text" json:"payload"`          // JSON string
	State           string `gorm:"column:state;index;type:varchar(16)" json:"state"` // pending|processing|done|failed|dead
	...
	RunAt           int64  `gorm:"column:run_at;index" json:"runAt"` // ms timestamp
	LeaseOwner      string `gorm:"column:lease_owner;index;type:varchar(64)" json:"leaseOwner"`
	LeaseExpiresAt  *int64 `gorm:"column:lease_expires_at;index" json:"leaseExpiresAt"`
	RequiresNetwork bool   `gorm:"column:requires_network" json:"requiresNetwork"`

	// Ordered processing and deduplication/idempotency
	PartitionKey   string  `gorm:"column:partition_key;index;type:varchar(128)" json:"partitionKey"` // e.g., conversationID
	Seq            *int64  `gorm:"column:seq" json:"seq"`                                            // Optional: in-partition order
	DedupeKey      *string `gorm:"column:dedupe_key;uniqueIndex;type:varchar(256)" json:"dedupeKey"` // Merge similar events
	IdempotencyKey string  `gorm:"column:idempotency_key;index;type:varchar(256)" json:"idempotencyKey"`

	CreatedAt int64 `gorm:"column:created_at" json:"createdAt"`
	UpdatedAt int64 `gorm:"column:updated_at" json:"updatedAt"`
}

// LocalEventIdempotency records processed idempotency keys to ensure at-least-once semantics.
type LocalEventIdempotency struct {
	IdempotencyKey string `gorm:"column:idempotency_key;primary_key;type:varchar(256)" json:"idempotencyKey"`
	DoneAt         int64  `gorm:"column:done_at" json:"doneAt"`
}

type HotKey struct {
	Namespace string `gorm:"column:namespace;primaryKey;type:text" json:"namespace"`
	Key       string `gorm:"column:key;primaryKey;type:text" json:"key"`
	LastTouch int64  `gorm:"column:last_touch" json:"lastTouch"`
}

func (HotKey) TableName() string {
	return "hot_keys"
}
...
type LocalUser struct {
	...
	AddFriendPermission int32  `gorm:"column:add_friend_permission" json:"addFriendPermission"`
}
...
type LocalChatLog struct {
	...
	SessionID        string `gorm:"column:session_id;type:varchar(128)" json:"sessionId"`
	//DstUserIDs       StringArray `gorm:"column:dst_user_ids;type:text" json:"dstUserIDs"`
}
...
type LocalConversation struct {
	...
	IsMarked              bool   `gorm:"column:is_marked" json:"isMarked"`
	IsHidden              bool   `gorm:"column:is_hidden" json:"isHidden"`
...
type LocalConversationGroup struct {
	ConversationGroupID   string   `gorm:"column:conversation_group_id;primary_key;type:varchar(64)" json:"conversationGroupID"`
	Name                  string   `gorm:"column:name;type:varchar(255)" json:"name"`
	Serial                int64    `gorm:"column:serial" json:"serial"`
	Version               int64    `gorm:"column:version" json:"version"`
	Ex                    string   `gorm:"column:ex;type:varchar(1024)" json:"ex"`
	ConversationGroupType int32    `gorm:"column:conversation_group_type" json:"conversationGroupType"`
	Hidden                bool     `gorm:"column:hidden" json:"hidden"`
	UnreadCount           int32    `gorm:"-:all" json:"unreadCount"`
	ConversationIDs       []string `gorm:"-:all" json:"conversationIDs"`
}

func (LocalConversationGroup) TableName() string {
	return "local_conversation_groups"
}

type LocalConversationGroupMember struct {
	ConversationID      string `gorm:"column:conversation_id;primary_key;type:char(128)" json:"conversationID"`
	ConversationGroupID string `gorm:"column:conversation_group_id;primary_key;type:varchar(64)" json:"conversationGroupID"`
}

func (LocalConversationGroupMember) TableName() string {
	return "local_conversation_group_members"
}
