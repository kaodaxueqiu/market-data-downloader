...
func SetSignalingListener(listener open_im_sdk_callback.OnSignalingListener) {
	listenerCall(IMUserContext.SetSignalingListener, listener)
}

func SetForServiceListener(listener open_im_sdk_callback.OnListenerForService) {
	listenerCall(IMUserContext.SetForServiceListener, listener)
}

func SetConversationGroupListener(listener open_im_sdk_callback.OnConversationGroupListener) {
	listenerCall(IMUserContext.SetConversationGroupListener, listener)
}
