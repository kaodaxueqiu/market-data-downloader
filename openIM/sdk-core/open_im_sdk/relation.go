...
func DeleteFriendRequests(callback open_im_sdk_callback.Base, operationID string, req string) {
	call(callback, operationID, IMUserContext.Relation().DeleteFriendRequests, req)
}
