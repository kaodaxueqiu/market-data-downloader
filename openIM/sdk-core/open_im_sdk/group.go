...
func ChangeGroupMute(callback open_im_sdk_callback.Base, operationID string, groupID string, isMute bool, muteBypassUserIDs string) {
	call(callback, operationID, IMUserContext.Group().ChangeGroupMute, groupID, isMute, muteBypassUserIDs)
}
...
func DeleteGroupRequests(callback open_im_sdk_callback.Base, operationID string, req string) {
	call(callback, operationID, IMUserContext.Group().DeleteGroupRequests, req)
}
