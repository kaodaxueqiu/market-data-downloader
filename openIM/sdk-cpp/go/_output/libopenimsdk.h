...
extern __declspec(dllexport) void set_message_kv_listener(CB_I_S cCallback);
extern __declspec(dllexport) void set_signaling_listener(CB_I_S cCallback);
extern __declspec(dllexport) void set_for_service_listener(CB_I_S cCallback);
extern __declspec(dllexport) void set_conversation_group_listener(CB_I_S cCallback);
...
extern __declspec(dllexport) char* create_markdown_message(char* operationID, char* text);
...
extern __declspec(dllexport) void unhide_conversation(CB_S_I_S_S cCallback, char* operationID, char* conversationID);
...
extern __declspec(dllexport) void create_conversation_group(CB_S_I_S_S cCallback, char* operationID, char* req);
extern __declspec(dllexport) void update_conversation_group(CB_S_I_S_S cCallback, char* operationID, char* req);
extern __declspec(dllexport) void delete_conversation_group(CB_S_I_S_S cCallback, char* operationID, char* conversationGroupID);
extern __declspec(dllexport) void get_conversation_groups(CB_S_I_S_S cCallback, char* operationID, long long int conversationGroupType);
extern __declspec(dllexport) void set_conversation_group_order(CB_S_I_S_S cCallback, char* operationID, char* orders);
extern __declspec(dllexport) void add_conversations_to_groups(CB_S_I_S_S cCallback, char* operationID, char* conversationIDs, char* conversationGroupIDs);
extern __declspec(dllexport) void remove_conversations_from_groups(CB_S_I_S_S cCallback, char* operationID, char* conversationIDs, char* conversationGroupIDs);
extern __declspec(dllexport) void get_conversation_group_by_conversation_id(CB_S_I_S_S cCallback, char* operationID, char* conversationID);
extern __declspec(dllexport) void get_conversation_group_info_with_conversations(CB_S_I_S_S cCallback, char* operationID, char* req);
...
extern __declspec(dllexport) void get_local_all_history_messages(CB_S_I_S_S_I cCallback, char* operationID, char* req);
...
extern __declspec(dllexport) void set_message_local_content(CB_S_I_S_S cCallback, char* operationID, char* conversationID, char* message);
...
extern __declspec(dllexport) void modify_message(CB_S_I_S_S cCallback, char* operationID, char* req);
extern __declspec(dllexport) void delete_messages(CB_S_I_S_S cCallback, char* operationID, char* req);
extern __declspec(dllexport) void delete_user_all_messages_in_conv(CB_S_I_S_S cCallback, char* operationID, char* conversationID, char* userID);
extern __declspec(dllexport) void set_conversation_pinned_msg(CB_S_I_S_S cCallback, char* operationID, char* conversationID, char* clientMsgID, int pinned);
extern __declspec(dllexport) void get_conversation_pinned_msg(CB_S_I_S_S cCallback, char* operationID, char* conversationID);
extern __declspec(dllexport) void reset_conversation_unread(CB_S_I_S_S cCallback, char* operationID, char* req);
...
extern __declspec(dllexport) void get_file_transfer(CB_S_I_S_S cCallback, char* operationID);
extern __declspec(dllexport) void upload_file(CB_S_I_S_S cCallback, char* operationID, char* req, CB_I_S uploadCallback);
extern __declspec(dllexport) void cancel_upload(CB_S_I_S_S cCallback, char* operationID, char* cancelID);
...
extern __declspec(dllexport) void delete_friend_requests(CB_S_I_S_S cCallback, char* operationID, char* req);
...
//
extern __declspec(dllexport) void change_group_mute(CB_S_I_S_S cCallback, char* operationID, char* cGroupID, int cIsMute, char* muteBypassUserIDs);
...
//
extern __declspec(dllexport) void check_local_group_full_sync(CB_S_I_S_S cCallback, char* operationID);

// CheckGroupMemberFullSync checks if the group members are fully synchronized
//
extern __declspec(dllexport) void check_group_member_full_sync(CB_S_I_S_S cCallback, char* operationID, char* cGroupID);
...
extern __declspec(dllexport) void delete_group_requests(CB_S_I_S_S cCallback, char* operationID, char* req);
...
extern __declspec(dllexport) void create_timer_task(CB_S_I_S_S cCallback, char* operationID, char* req);
extern __declspec(dllexport) void update_timer_task(CB_S_I_S_S cCallback, char* operationID, char* req);
extern __declspec(dllexport) void delete_timer_task(CB_S_I_S_S cCallback, char* operationID, char* req);
extern __declspec(dllexport) void get_timer_task(CB_S_I_S_S cCallback, char* operationID, char* req);
extern __declspec(dllexport) void list_timer_tasks(CB_S_I_S_S cCallback, char* operationID, char* req);
extern __declspec(dllexport) void create_message_timer_task(CB_S_I_S_S cCallback, char* operationID, char* req);
extern __declspec(dllexport) void create_http_timer_task(CB_S_I_S_S cCallback, char* operationID, char* req);
extern __declspec(dllexport) void create_rpc_timer_task(CB_S_I_S_S cCallback, char* operationID, char* req);
extern __declspec(dllexport) void create_preset_timer_task(CB_S_I_S_S cCallback, char* operationID, char* req);
extern __declspec(dllexport) void update_message_timer_task(CB_S_I_S_S cCallback, char* operationID, char* req);
extern __declspec(dllexport) void update_http_timer_task(CB_S_I_S_S cCallback, char* operationID, char* req);
extern __declspec(dllexport) void update_rpc_timer_task(CB_S_I_S_S cCallback, char* operationID, char* req);
extern __declspec(dllexport) void update_preset_timer_task(CB_S_I_S_S cCallback, char* operationID, char* req);
extern __declspec(dllexport) void speech_to_text(CB_S_I_S_S cCallback, char* operationID, char* req);
extern __declspec(dllexport) void speech_to_text_capabilities(CB_S_I_S_S cCallback, char* operationID);
...
extern __declspec(dllexport) void upload_logs(CB_S_I_S_S cCallback, char* operationID, int line, char* cancelID, char* ex, CB_I_S uploadLogProgressCallback);
