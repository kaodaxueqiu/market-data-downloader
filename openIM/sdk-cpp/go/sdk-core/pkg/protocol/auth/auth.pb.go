...
func (x *ForceLogoutReq) GetKickType() string {
	if x != nil {
		return x.KickType
	}
	return ""
...
func (x *ForceLogoutReq) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
type DeleteUsersTokensReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *DeleteUsersTokensReq) Reset() {
	*x = DeleteUsersTokensReq{}
	mi := &file_auth_auth_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeleteUsersTokensReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteUsersTokensReq) ProtoMessage() {}

func (x *DeleteUsersTokensReq) ProtoReflect() protoreflect.Message {
	mi := &file_auth_auth_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteUsersTokensReq.ProtoReflect.Descriptor instead.
func (*DeleteUsersTokensReq) Descriptor() ([]byte, []int) {
	return file_auth_auth_proto_rawDescGZIP(), []int{12}
}

func (x *DeleteUsersTokensReq) GetUserIDs() []string {
	if x != nil {
		return x.UserIDs
	}
	return nil
...
type DeleteUsersTokensResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DeleteUsersTokensResp) Reset() {
	*x = DeleteUsersTokensResp{}
	mi := &file_auth_auth_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeleteUsersTokensResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteUsersTokensResp) ProtoMessage() {}

func (x *DeleteUsersTokensResp) ProtoReflect() protoreflect.Message {
	mi := &file_auth_auth_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteUsersTokensResp.ProtoReflect.Descriptor instead.
func (*DeleteUsersTokensResp) Descriptor() ([]byte, []int) {
...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\x0ekickTokensResp\"0\n" +
	"\x14deleteUsersTokensReq\x12\x18\n" +
	"\auserIDs\x18\x01 \x03(\tR\auserIDs\"\x17\n" +
	"\x15deleteUsersTokensResp2\xad\x04\n" +
	"\x04Auth\x12N\n" +
	...
	"\n" +
	"kickTokens\x12\x1a.openim.auth.kickTokensReq\x1a\x1b.openim.auth.kickTokensResp\x12Z\n" +
	"\x11deleteUsersTokens\x12!.openim.auth.deleteUsersTokensReq\x1a\".openim.auth.deleteUsersTokensRespB$Z\"github.com/openimsdk/protocol/authb\x06proto3"
...
var file_auth_auth_proto_goTypes = []any{
	...
	(*DeleteUsersTokensReq)(nil),  // 12: openim.auth.deleteUsersTokensReq
	(*DeleteUsersTokensResp)(nil), // 13: openim.auth.deleteUsersTokensResp
}
var file_auth_auth_proto_depIdxs = []int32{
	...
	12, // 6: openim.auth.Auth.deleteUsersTokens:input_type -> openim.auth.deleteUsersTokensReq
	...
	13, // 13: openim.auth.Auth.deleteUsersTokens:output_type -> openim.auth.deleteUsersTokensResp
