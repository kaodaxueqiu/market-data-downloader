...
type IndexDB struct {
	...
	*indexdb.LocalConversationGroups
	*indexdb.LocalConversationGroupMembers
	*indexdb.LocalGroups
...
func NewDataBase(ctx context.Context, loginUserID string, dbDir string, logLevel int) (*IndexDB, error) {
	i := &IndexDB{
		...
		LocalConversationGroups:         indexdb.NewLocalConversationGroups(),
		LocalConversationGroupMembers:   indexdb.NewLocalConversationGroupMembers(),
		LocalGroups:                     indexdb.NewLocalGroups(),
		LocalGroupMember:                indexdb.NewLocalGroupMember(loginUserID),
		...
		Event:                           indexdb.NewEvent(loginUserID),
		HotKeys:                         indexdb.NewHotKeys(),
