...
type OnConversationGroupListener interface {
	OnConversationGroupAdded(conversationGroupList string)
	OnConversationGroupDeleted(conversationGroupList string)
	OnConversationGroupChanged(conversationGroupList string)
	OnConversationGroupMemberAdded(conversationList string)
	OnConversationGroupMemberDeleted(conversationList string)
}
...
type OnAdvancedMsgListener interface {
	...
	OnDeleteUserAllMsgsInConv(message string)
	OnRecvOnlineOnlyMessage(message string)
	OnChangedPinnedMsg(message string)
}
