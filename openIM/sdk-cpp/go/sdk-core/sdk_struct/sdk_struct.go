...
type GroupMessageReadInfo struct {
	...
	HasReadCount int64                            `json:"hasReadCount"`
	UnreadCount  int64                            `json:"unreadCount"`
	ReadUsers    []*ReaderInfo                    `json:"-"`
	ReadMembers  []*model_struct.LocalGroupMember `json:"readMembers,omitempty"`
}
...
type SoundElem struct {
	...
	Duration  int64      `json:"duration"`
	SoundType string     `json:"soundType,omitempty"`
	Text      *SoundText `json:"text,omitempty"`
}

type SoundText struct {
...
type MsgStruct struct {
	...
	//DstUserIDs       []string               `json:"dstUserIDs,omitempty"`
}

func (x *MsgStruct) ConversationID() string {
...
type GroupHasReadInfo struct {
	HasReadUserList []*ReaderInfo `json:"-"`
	HasReadCount    int64         `json:"hasReadCount"`
	UnreadCount     int64         `json:"unreadCount"`
}
...
type IMConfig struct {
	...
	DiagnoseHashSalt    string `json:"diagnoseHashSalt,omitempty"`
	...
	TLS                       xtls.ClientConfig `json:"tls"`
	HttpClientMode            int
}
...
type DeleteMsgsListenerMsg struct {
	ConversationID string `json:"conversationID"`
	UserID         string `json:"userID"`
}

type DeleteUserAllMsgsListenerMsg struct {
	ConversationID string `json:"conversationID"`
	UserID         string `json:"userID"`
}
