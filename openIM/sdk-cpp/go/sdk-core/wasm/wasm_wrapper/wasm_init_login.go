...
func (s *SetListener) setConversationGroupListener() {
	callback := event_listener.NewConversationGroupCallback(s.commonFunc)
	open_im_sdk.SetConversationGroupListener(callback)
}
...
func (s *SetListener) SetAllListener() {
	...
	s.setConversationGroupListener()
}
