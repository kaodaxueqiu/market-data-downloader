...
func (r *Relation) doNotification(ctx context.Context, msg *sdkws.MsgData) error {
	...
	case constant.FriendApplicationNotification:
		...
		r.friendshipListener.OnFriendApplicationAdded(*converter.ServerFriendRequestToLocal(tips.Request))
	case constant.FriendApplicationApprovedNotification:
		...
		if tips.Request != nil {
			r.friendshipListener.OnFriendApplicationAccepted(*converter.ServerFriendRequestToLocal(tips.Request))
		}
	...
	case constant.FriendApplicationRejectedNotification:
		...
		r.friendshipListener.OnFriendApplicationRejected(*converter.ServerFriendRequestToLocal(tips.Request))
