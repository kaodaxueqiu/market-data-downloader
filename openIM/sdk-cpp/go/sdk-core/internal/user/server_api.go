...
func (u *User) getFileTransfer(ctx context.Context) ([]*sdkws.UserInfo, error) {
	req := &user.GetSpecialUsersReq{Category: constant.FileTransferCategory}
	return api.ExtractField(ctx, api.GetSpecialUsers.Invoke, req, (*user.GetSpecialUsersResp).GetUsers)
}
