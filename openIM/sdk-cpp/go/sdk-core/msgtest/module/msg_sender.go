...
func NewUser(userID, token string, timeOffset int64, p *PressureTester, imConfig sdk_struct.IMConfig, opts ...func(core *SendMsgUser)) *SendMsgUser {
	...
	longConnMgr := interaction.NewLongConnMgr(ctx, func(m map[string][]int32) {}, pushMsgAndMaxSeqCh, nil, nil)
	longConnMgr.SetLoginUserID(userID)
	core := &SendMsgUser{
...
func (c *ConnListener) OnKickedOffline(msg string)       {}
