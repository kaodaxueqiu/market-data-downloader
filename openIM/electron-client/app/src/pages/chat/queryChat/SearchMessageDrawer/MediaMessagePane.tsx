  ...
  const showAlbum = useCallback(
    (clientMsgID: string) => {
      ...
      if (
        ...
        downloadFile(
          loadState.previewItems[current].url,
          buildMessageDownloadData({
            clientMsgID,
            conversationID,
            saveType: "image",
            ...
            switch (index) {
              case 0:
                return messageList.length ? (
                  <MediaMessageRow
                    title={t("common.dateTime.relative.thisWeek")}
              ...
              case 1:
                return messageList.length ? (
                  <MediaMessageRow
                    title={t("common.dateTime.relative.thisMonth")}
                    messageList={messageList}
                    preview={showAlbum}
                    conversationID={conversationID}
                    closeOverlay={closeOverlay}
              ...
              case 2:
                return messageList.length ? (
                  <MediaMessageRow
                    title={t("common.dateTime.relative.earlier")}
                    messageList={messageList}
                    preview={showAlbum}
                    conversationID={conversationID}
                    closeOverlay={closeOverlay}
...
const MediaItem = ({
  ...
  return (
    ...
    >
      <div
        className={clsx(
          "grid-image relative flex h-22.5 items-center justify-center overflow-hidden rounded-md",
