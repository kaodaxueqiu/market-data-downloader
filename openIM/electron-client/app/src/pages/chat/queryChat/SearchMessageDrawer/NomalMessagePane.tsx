...
export const NomalMessageItem = ({
  ...
  return (
    <JumpToMessageWrap
      ...
      isChildWindow={false}
      conversationID={conversationID!}
      viewInFinder={message.contentType === MessageType.FileMessage}
      afterJump={closeOverlay}
    >
      <div
        className="flex items-start rounded-md px-3.5 py-3 hover:bg-(--primary-active)"
        ...
        <div className="ml-3 flex-1 select-text">
          <div className="mb-1 flex items-center text-xs">
            <div
              ...
              className="max-w-[30%] truncate text-(--sub-text)"
            >
              {message.senderNickname}
            </div>
            <div className="ml-2 text-(--sub-text)">
