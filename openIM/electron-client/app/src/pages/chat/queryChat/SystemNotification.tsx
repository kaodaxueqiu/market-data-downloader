import { FileElem, PictureElem, SoundElem, VideoElem } from "@openim/wasm-client-sdk";
...
const SystemNotification: FC<{ message: ExMessageItem }> = ({ message }) => {
  return (
    <div className="relative flex px-5 py-3 pt-9 select-text">
        ...
        <div className="ml-3 flex-1">
          <div className="flex leading-4">
            <div
              ...
              className="mr-2 max-w-[30%] truncate text-(--sub-text)"
            >
      ...
      {message.gapTime && (
        <div className="absolute top-3 left-1/2 -translate-x-1/2 text-xs text-(--sub-text)">
