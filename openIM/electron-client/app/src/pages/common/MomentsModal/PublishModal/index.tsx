...
import emitter, { SelectUserParams } from "@/utils/window/events";
...
> = ({ activeUserID, withVideo = false }, ref) => {
  ...
  return (
    ...
    >
      <div className="flex min-h-120 flex-col bg-[#F4F5F7]">
        <div className="flex min-h-10 items-center justify-center bg-white">
          {!withVideo
            ? t("contact.text.publishImages")
            : t("contact.text.publishVideo")}
        </div>
        <PrepareContent
