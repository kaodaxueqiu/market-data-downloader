import { BlackUserItem, CbEvents, WSEvent } from "@openim/wasm-client-sdk";
...
export const PersonalSettings = () => {
  ...
  const precheck = str ? JSON.parse(decodeURIComponent(str)) : {};
  ...
  return (
    <div className="h-full bg-(--chat-bubble)">
      <PersonalSettingsContent
        closeOverlay={closeWindow}
        highlightCloseAction={precheck?.highlightCloseAction}
      />
    </div>
  );
};
