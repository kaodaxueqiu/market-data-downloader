...
import { GroupItem, GroupMemberItem, ViewType } from "@openim/wasm-client-sdk";
...
type EmitterEvents = {
  ...
  CHOOSE_MODAL_CLOSED: ChooseModalState;
  ...
  OPEN_PERSONAL_SETTINGS: { highlightCloseAction?: boolean } | undefined;
  CHECK_APP_UPDATE: AppUpdateCheckPayload;
};

export type WindowEmitterEvents = {
  // to main window
  USER_LOGOUT: void;
...
export type WindowKey = "main" | "global-search" | "moments";
...
export type AppUpdateCheckSource = "startup" | "login" | "timer" | "manual";

export type AppUpdateCheckPayload = {
