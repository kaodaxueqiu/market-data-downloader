...
import { BlackUserItem } from "@openim/wasm-client-sdk";
...
export const BlackListContent = ({ closeOverlay }: { closeOverlay?: () => void }) => {
  ...
  return (
    <div className="flex h-117 flex-col bg-(--chat-bubble)">
      <div className="flex items-center justify-between bg-(--gap-text) p-5">
        <span className="text-base font-medium">{t("settings.text.blackList")}</span>
        <CloseOutlined
