...
export declare function converSqlExecResult(record: QueryExecResult, keyType?: KeyType, booleanKeys?: string[], convertMap?: Record<string, string>, string2ArrayKeys?: string[]): Record<string, unknown>[];
