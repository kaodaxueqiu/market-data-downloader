...
declare class SDK extends Emitter {
    ...
    modifyMessage: (params: ModifyMessageParams, operationID?: string) => Promise<WsResponse<MessageItem>>;
    deleteMessages: <T>(data: DeleteMessagesParams, operationID?: string) => Promise<WsResponse<T>>;
    deleteUserAllMessagesInConv: <T>(data: DeleteUserMsgInConvParams, operationID?: string) => Promise<WsResponse<T>>;
    ...
    createMarkdownMessage: (text: string, operationID?: string) => Promise<WsResponse<MessageItem>>;
    createConversationGroup: (data: CreateConversationGroupReq, operationID?: string) => Promise<WsResponse<ConversationGroup>>;
    updateConversationGroup: (data: UpdateConversationGroupReq, operationID?: string) => Promise<WsResponse<ConversationGroup>>;
    deleteConversationGroup: <T>(groupID: string, operationID?: string) => Promise<WsResponse<T>>;
    getConversationGroups: (conversationGroupType: ConversationGroupType, operationID?: string) => Promise<WsResponse<ConversationGroup[]>>;
    setConversationGroupOrder: <T>(data: SetConversationGroupOrderReq[], operationID?: string) => Promise<WsResponse<T>>;
    addConversationsToGroups: <T>(data: AddConversationsToGroupParams, operationID?: string) => Promise<WsResponse<T>>;
    removeConversationsFromGroups: <T>(data: RemoveConversationsFromGroupParams, operationID?: string) => Promise<WsResponse<T>>;
    getConversationGroupIDsByConversationID: (conversationID: string, operationID?: string) => Promise<WsResponse<string[]>>;
    getConversationGroupInfoWithConversations: (data: GetConversationGroupInfoWithConversationsReq, operationID?: string) => Promise<WsResponse<GetConversationGroupInfoWithConversationsResp>>;
    speechToText: (data: SpeechToTextParams, operationID?: string) => Promise<WsResponse<{
        text: string;
    }>>;
    speechToTextCapabilities: (operationID?: string) => Promise<WsResponse<SpeechToTextCapabilities>>;
    setMessageLocalContent: (data: SetMessageLocalContentParams, operationID?: string) => Promise<WsResponse<void>>;
