...
export declare function searchMessageByKeyword(conversationID: string, contentTypeStr: string, senderUserIDListStr: string, keywordListStr: string, keywordListMatchType: number, startTime: number, endTime: number, offset: number, count: number): Promise<string>;
export declare function searchMessageByContentType(conversationID: string, contentTypeStr: string, senderUserIDListStr: string, startTime: number, endTime: number, offset: number, count: number): Promise<string>;
export declare function searchMessageByContentTypeAndKeyword(conversationID: string, contentTypeStr: string, senderUserIDListStr: string, keywordListStr: string, keywordListMatchType: number, startTime: number, endTime: number): Promise<string>;
...
export declare function deleteMessagesByClientMsgIDs(conversationID: string, clientMsgIDListStr: string): Promise<string>;
...
export declare function getMessageByUserID(conversationID: string, userID: string): Promise<string>;
