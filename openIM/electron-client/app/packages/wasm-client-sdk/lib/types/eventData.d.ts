...
import { BlackUserItem, ConversationGroup, ConversationGroupMemberChangedCallbackData, ConversationInputStatus, ConversationItem, FriendApplicationItem, FriendUserItem, GroupApplicationItem, GroupItem, GroupMemberItem, GroupMessageReceiptInfo, MessageItem, PinnedMessageChangeData, ReceiptInfo, RevokedInfo, SelfUserInfo, UploadProgressData, UserOnlineState } from './entity';
