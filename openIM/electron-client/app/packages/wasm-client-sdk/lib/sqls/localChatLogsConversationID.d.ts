...
export declare function searchMessageByKeyword(db: Database, conversationID: string, contentType: number[], senderUserIDList: string[], keywordList: string[], keywordListMatchType: number, startTime: number, endTime: number, offset: number, count: number): QueryExecResult[];
export declare function searchMessageByContentType(db: Database, conversationID: string, contentType: number[], senderUserIDList: string[], startTime: number, endTime: number, offset: number, count: number): QueryExecResult[];
export declare function searchMessageByContentTypeAndKeyword(db: Database, conversationID: string, contentType: number[], senderUserIDList: string[], keywordList: string[], keywordListMatchType: number, startTime: number, endTime: number): QueryExecResult[];
...
export declare function deleteMessagesByClientMsgIDs(db: Database, conversationID: string, clientMsgIDs: string[]): QueryExecResult[];
...
export declare function getMessageByUserID(db: Database, conversationID: string, userID: string): QueryExecResult[];
