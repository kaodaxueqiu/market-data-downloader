...
(function (CbEvents) {
    ...
    CbEvents["OnMsgDeleted"] = "OnMsgDeleted";
    CbEvents["OnDeleteUserAllMsgsInConv"] = "OnDeleteUserAllMsgsInConv";
    CbEvents["OnRecvNewMessage"] = "OnRecvNewMessage";
    CbEvents["OnRecvNewMessages"] = "OnRecvNewMessages";
    CbEvents["OnMessageModified"] = "OnMessageModified";
    CbEvents["OnChangedPinnedMsg"] = "OnChangedPinnedMsg";
    ...
    // conversation group
    CbEvents["OnConversationGroupAdded"] = "OnConversationGroupAdded";
    CbEvents["OnConversationGroupDeleted"] = "OnConversationGroupDeleted";
    CbEvents["OnConversationGroupChanged"] = "OnConversationGroupChanged";
    CbEvents["OnConversationGroupMemberAdded"] = "OnConversationGroupMemberAdded";
    CbEvents["OnConversationGroupMemberDeleted"] = "OnConversationGroupMemberDeleted";
    // unuse
...
function initDatabaseAPI(isLogStandardOutput = true) {
    ...
    window.deleteMessagesByClientMsgIDs = registeMethodOnWindow('deleteMessagesByClientMsgIDs');
    ...
    window.getConversationUnreadCountMap = registeMethodOnWindow('getConversationUnreadCountMap');
    // users
    ...
    window.deleteSelfFriendRequests = registeMethodOnWindow('deleteSelfFriendRequests');
    ...
    window.deleteGroupRequestsFromUserID = registeMethodOnWindow('deleteGroupRequestsFromUserID');
    ...
    // conversation groups
    window.insertConversationGroupDB = registeMethodOnWindow('insertConversationGroup');
    window.batchInsertConversationGroupsDB = registeMethodOnWindow('batchInsertConversationGroups');
    window.upsertConversationGroupsDB = registeMethodOnWindow('upsertConversationGroups');
    window.updateConversationGroupDB = registeMethodOnWindow('updateConversationGroup');
    window.deleteConversationGroupDB = registeMethodOnWindow('deleteConversationGroup');
    window.deleteAllConversationGroupDB = registeMethodOnWindow('deleteAllConversationGroups');
    window.getConversationGroupDB = registeMethodOnWindow('getConversationGroup');
    window.getConversationGroupsDB = registeMethodOnWindow('getConversationGroups');
    window.getAllConversationGroupsDB = registeMethodOnWindow('getAllConversationGroups');
    window.updateConversationGroupSerialDB = registeMethodOnWindow('updateConversationGroupSerial');
    window.addConversationGroupMembersDB = registeMethodOnWindow('addConversationGroupMembers');
    window.removeConversationGroupMembersDB = registeMethodOnWindow('removeConversationGroupMembers');
    window.getConversationGroupIDsByConversationIdDB = registeMethodOnWindow('getConversationGroupIDsByConversationID');
    window.getConversationIDsByGroupIdDB = registeMethodOnWindow('getConversationIDsByGroupID');
    window.deleteConversationGroupMembersByGroupIdDB = registeMethodOnWindow('deleteConversationGroupMembersByGroupID');
}
...
(function (Platform) {
    ...
    Platform[Platform["Harmony"] = 11] = "Harmony";
})(Platform || (Platform = {}));
var LogLevel;
(function (LogLevel) {
...
(function (MessageType) {
    ...
    MessageType[MessageType["MarkdownMessage"] = 118] = "MarkdownMessage";
    MessageType[MessageType["StreamMessage"] = 143] = "StreamMessage";
    ...
    MessageType[MessageType["MsgPinned"] = 2400] = "MsgPinned";
...
(function (ConversationGroupType) {
    ConversationGroupType[ConversationGroupType["ConversationGroupTypeNormal"] = 0] = "ConversationGroupTypeNormal";
    ConversationGroupType[ConversationGroupType["ConversationGroupTypeFilter"] = 1] = "ConversationGroupTypeFilter";
    ConversationGroupType[ConversationGroupType["ConversationGroupTypeAll"] = 2] = "ConversationGroupTypeAll";
...
class SDK extends Emitter {
    constructor(url = '/openIM.wasm', debug = true) {
        ...
        this.deleteFriendRequests = (params, operationID = v4()) => {
            return this._invoker('deleteFriendRequests ', window.deleteFriendRequests, [
                operationID,
                JSON.stringify({
        ...
        this.changeGroupMute = (data, operationID = v4()) => {
            ...
            return this._invoker('changeGroupMute ', window.changeGroupMute, [
                ...
                data.groupID,
                data.isMute,
                JSON.stringify((_a = data.muteBypassUserIDs) !== null && _a !== void 0 ? _a : []),
            ]);
        };
        ...
        this.deleteGroupRequests = (params, operationID = v4()) => {
            return this._invoker('deleteGroupRequests ', window.deleteGroupRequests, [
                operationID,
                JSON.stringify({
        ...
        this.createTargetedGroupMessage = (params, operationID = v4()) => {
            return this._invoker('createTargetedGroupMessage', window.createTargetedGroupMessage, [
                operationID,
                JSON.stringify(params.message),
        ...
        this.modifyMessage = (params, operationID = v4()) => {
            return this._invoker('modifyMessage', window.modifyMessage, [operationID, JSON.stringify(params)], data => {
                // compitable with old version sdk
                return data[0];
            });
        };
        this.deleteMessages = (data, operationID = v4()) => {
            return this._invoker('deleteMessages ', window.deleteMessages, [
                operationID,
                JSON.stringify(data),
            ]);
        };
        this.deleteUserAllMessagesInConv = (data, operationID = v4()) => {
            return this._invoker('deleteUserAllMessagesInConv ', window.deleteUserAllMessagesInConv, [operationID, data.conversationID, data.userID]);
        };
        this.setConversationPinnedMsg = (data, operationID = v4()) => {
            return this._invoker('setConversationPinnedMsg ', window.setConversationPinnedMsg, [operationID, data.conversationID, data.clientMsgID, data.pinned]);
        };
        this.getConversationPinnedMsg = (data, operationID = v4()) => {
            return this._invoker('getConversationPinnedMsg ', window.getConversationPinnedMsg, [operationID, data]);
        };
        this.createMarkdownMessage = (text, operationID = v4()) => {
            return this._invoker('createMarkdownMessage', window.createMarkdownMessage, [operationID, text], data => {
                // compitable with old version sdk
                return data[0];
            });
        };
        this.createConversationGroup = (data, operationID = v4()) => {
            return this._invoker('createConversationGroup', window.createConversationGroup, [operationID, JSON.stringify(data)]);
        };
        this.updateConversationGroup = (data, operationID = v4()) => {
            return this._invoker('updateConversationGroup', window.updateConversationGroup, [operationID, JSON.stringify(data)]);
        };
        this.deleteConversationGroup = (groupID, operationID = v4()) => {
            return this._invoker('deleteConversationGroup', window.deleteConversationGroup, [operationID, groupID]);
        };
        this.getConversationGroups = (conversationGroupType, operationID = v4()) => {
            return this._invoker('getConversationGroups', window.getConversationGroups, [operationID, conversationGroupType]);
        };
        this.setConversationGroupOrder = (data, operationID = v4()) => {
            return this._invoker('setConversationGroupOrder', window.setConversationGroupOrder, [operationID, JSON.stringify(data)]);
        };
        this.addConversationsToGroups = (data, operationID = v4()) => {
            return this._invoker('addConversationsToGroups', window.addConversationsToGroups, [
                operationID,
                JSON.stringify(data.conversationIDs),
                JSON.stringify(data.conversationGroupIDs),
            ]);
        };
        this.removeConversationsFromGroups = (data, operationID = v4()) => {
            return this._invoker('removeConversationsFromGroups', window.removeConversationsFromGroups, [
                operationID,
                JSON.stringify(data.conversationIDs),
                JSON.stringify(data.conversationGroupIDs),
            ]);
        };
        this.getConversationGroupIDsByConversationID = (conversationID, operationID = v4()) => {
            return this._invoker('getConversationGroupIDsByConversationID', window.getConversationGroupIDsByConversationID, [operationID, conversationID]);
        };
        this.getConversationGroupInfoWithConversations = (data, operationID = v4()) => {
            return this._invoker('getConversationGroupInfoWithConversations', window.getConversationGroupInfoWithConversations, [operationID, JSON.stringify(data)]);
        };
        this.speechToText = (data, operationID = v4()) => {
            return this._invoker('speechToText', window.speechToText, [operationID, JSON.stringify(data)]);
        };
        this.speechToTextCapabilities = (operationID = v4()) => {
            return this._invoker('speechToTextCapabilities', window.speechToTextCapabilities, [operationID]);
        };
        this.setMessageLocalContent = (data, operationID = v4()) => {
            return this._invoker('setMessageLocalContent', window.setMessageLocalContent, [operationID, data.conversationID, JSON.stringify(data.message)]);
        };
...
export { AddFriendPermission, AllowType, ApplicationHandleResult, CbEvents, ConversationGroupType, GroupAtType, GroupJoinSource, GroupMemberFilter, GroupMemberRole, GroupMessageReaderFilter, GroupStatus, GroupType, GroupVerificationType, LogLevel, LoginStatus, MessageReceiveOptType, MessageStatus, MessageType, OnlineState, Platform, Relationship, SessionType, ViewType, getSDK };
